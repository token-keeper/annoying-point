---
description: 짜증·좋은점을 한 줄로 남긴다 — /add <한마디> · /add +<좋은점>. 훅이 가로채 저장하므로 AI 턴을 쓰지 않는다
argument-hint: <한마디> | +<좋은점>
disable-model-invocation: true
---
Claude에서는 `/annoying-point:add <한마디>` 또는 플레인 텍스트 `$add <한마디>`로 입력한다 (bare `/add`는 미등록 커맨드라 동작하지 않는다).
